    ...
    class Keyboard
    {
        public:
            ...
            enum
            {
                ...
                N           = (unsigned short)'N',
                M           = (unsigned short)'M',  
                One         = (unsigned short)'1',
                Two         = (unsigned short)'2',
                Three       = (unsigned short)'3',
                Four        = (unsigned short)'4',
                Five        = (unsigned short)'5',
                Six         = (unsigned short)'6',
                Seven       = (unsigned short)'7',
                Eight       = (unsigned short)'8',
                Nine        = (unsigned short)'9',
